...
void RGBmatrixPanel::init(uint8_t rows, bool dbuf)
{
    ...
    int buffsize  = 32*nRows*3, // x3 = 3 bytes holds 4 planes "packed"
		...
		uint8_t* bytes = (uint8_t *)malloc(allocsize);
...
RGBmatrixPanel::RGBmatrixPanel(DigitalOut& r1,DigitalOut& r2,DigitalOut& g1,DigitalOut& g2,DigitalOut& b1,DigitalOut& b2,DigitalOut& a,DigitalOut& b,DigitalOut& c,DigitalOut& d,DigitalOut& sclk,DigitalOut& latch,DigitalOut& oe)
    :Adafruit_GFX(32, 32),
